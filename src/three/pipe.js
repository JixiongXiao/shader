    ...
    constructor(vec3Group,size) {
        ...
        if(A.z === B.z) {
            ...
            if(this.vec3Array.length <= 2){
                ...
                // const v4 = new THREE.Vector2(size,0)
            ...
            const v2 = new THREE.Vector2(size,-size)
            const v3 = new THREE.Vector2(size,size)
            // const v4 = new THREE.Vector2(0,size)
            this.vec2Group = [v1,v2,v3]
            this.type = 'left'
        }
...
//     constructor(vec3Group,size) {
//         const closedSpline = new THREE.CatmullRomCurve3( vec3Group )
//         closedSpline.curveType = 'catmullrom';
//         closedSpline.closed = false;
//         closedSpline.tension = 0;
...
//         }
//         const v1 = new THREE.Vector2(-size,0)
//         const v2 = new THREE.Vector2(-size,-size)
//         const v3 = new THREE.Vector2(size,-size)
//         const v4 = new THREE.Vector2(size,0)
//         const total = [...arr,v1,v2,v3,v4]
//         const shape1 = new THREE.Shape( total );
//         const texture = new THREE.TextureLoader().load('./textures/rock.png');
//         texture.wrapS = THREE.RepeatWrapping;
//         texture.wrapT = THREE.RepeatWrapping;
...
// 				// const material1 = new THREE.MeshLambertMaterial( { wireframe: false, side:THREE.BackSide, map:texture} );
// 				const material1 = new THREE.MeshLambertMaterial( { color: 0xb00000, wireframe: true } );
